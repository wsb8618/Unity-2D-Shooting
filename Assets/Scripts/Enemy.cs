...
public class Enemy : MonoBehaviour
{
    ...
    void FireFoward()
    {
        ...
        rigidR.AddForce(Vector2.down * Random.Range(5f, 7f), ForceMode2D.Impulse);
        rigidL.AddForce(Vector2.down * Random.Range(5f, 7f), ForceMode2D.Impulse);
        rigidRR.AddForce(Vector2.down * Random.Range(3f, 7f), ForceMode2D.Impulse);
        rigidLL.AddForce(Vector2.down * Random.Range(3f, 7f), ForceMode2D.Impulse);
    ...
    void FireShot()
    {
        ...
        for (int index = 0; index < 5; index++)
        {
            ...
            Vector2 ranVec = new Vector2(Random.Range(-1f, 1f), Random.Range(0f, 3.5f));
            dirVec += ranVec;
